 ...
 */
import { BankingEntityAccountView } from './bankingEntityAccountView';

export interface GetBankingEntityAccountsPageResponseBody {
  data?: Array<BankingEntityAccountView>;
  first?: boolean;
  last?: boolean;
  totalPages?: number;
