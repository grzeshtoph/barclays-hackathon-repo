...
export interface BankingEntityAccountView {
  id?: number;
  status?: BankingEntityAccountView.StatusEnum;
  accountOwningPartyId?: number;
  openingDate?: Date;
  currency?: Currency;
  balance?: number;
  formattedBalance?: string;
}
export namespace BankingEntityAccountView {
