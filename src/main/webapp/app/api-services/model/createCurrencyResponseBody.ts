 ...
 */
import { CreateCurrencyResponseBodyData } from './createCurrencyResponseBodyData';

export interface CreateCurrencyResponseBody {
  data?: CreateCurrencyResponseBodyData;
}
